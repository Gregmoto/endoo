...
const AGENCY_OWNER_PERMISSIONS: Permission[] = [
  ...
  CONTACT_PERMISSIONS.BULK_UPDATE,
  CONTACT_PERMISSIONS.EXPORT,
  CONTACT_PERMISSIONS.IMPORT,
  CONTACT_PERMISSIONS.VIES_VALIDATE,
  // Products
  PRODUCT_PERMISSIONS.READ,
  PRODUCT_PERMISSIONS.CREATE,
  PRODUCT_PERMISSIONS.UPDATE,
  PRODUCT_PERMISSIONS.DELETE,
  PRODUCT_PERMISSIONS.BULK_UPDATE,
  PRODUCT_PERMISSIONS.EXPORT,
  PRODUCT_PERMISSIONS.IMPORT,
  PRODUCT_PERMISSIONS.PRINT_LABELS,
  PRODUCT_PERMISSIONS.MANUAL_RESERVATION,
  ACCOUNT_MAPPING_PERMISSIONS.READ,
  ACCOUNT_MAPPING_PERMISSIONS.UPDATE,
  // Payments
  PAYMENT_PERMISSIONS.READ,
  PAYMENT_PERMISSIONS.CREATE,
  PAYMENT_PERMISSIONS.DELETE,
  PAYMENT_PERMISSIONS.IMPORT_FILE,
  PAYMENT_PERMISSIONS.WRITE_OFF_UNMATCHED,
  // Contracts
...
const AGENCY_STAFF_PERMISSIONS: Permission[] = [
  ...
  CONTRACT_PERMISSIONS.UPDATE,
  // Reminders + Recurring
  REMINDER_PERMISSIONS.READ,
  REMINDER_PERMISSIONS.SEND,
  RECURRING_PERMISSIONS.READ,
  RECURRING_PERMISSIONS.CREATE,
  RECURRING_PERMISSIONS.UPDATE,
  RECURRING_PERMISSIONS.ACTIVATE,
  RECURRING_PERMISSIONS.PAUSE,
  // Reports (read only)
  REPORT_PERMISSIONS.READ,
