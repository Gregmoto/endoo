    ...
    <main className="min-h-screen bg-card">
      ...
      <div className="bg-gradient-to-b from-gray-50 to-white py-16 px-6 border-b border">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-foreground leading-tight mb-5">Bokföring för småföretagare — en praktisk guide</h1>
      ...
      <article className="max-w-3xl mx-auto px-6 py-16">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Måste alla företag ha bokföring?</h2>
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Kontantmetoden vs. fakturametoden</h2>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
          Det finns två grundläggande sätt att bokföra:
        </p>

        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Kontantmetoden (kassabaserad)</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Fakturametoden (periodiserad)</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Vad ska du bokföra?</h2>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Moms — vad gäller?</h2>

        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Momsregistrering</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Momsperioder</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Ingående vs. utgående moms</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Löpande bokföring — praktiska tips</h2>

        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Boka ofta</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Spara alla underlag</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Håll företagsekonomi och privat isär</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Bokslut och årsredovisning</h2>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Sköta det själv eller anlita hjälp?</h2>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
