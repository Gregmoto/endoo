    ...
    <main className="min-h-screen bg-card">
      ...
      <div className="bg-gradient-to-b from-gray-50 to-white py-16 px-6 border-b border">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-foreground leading-tight mb-5">Vad är en balansrapport?</h1>
      ...
      <article className="max-w-3xl mx-auto px-6 py-16">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Vad visar en balansrapport?</h2>
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Tillgångar — vad äger företaget?</h2>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
          Tillgångarna delas in i <strong>anläggningstillgångar</strong> och <strong>omsättningstillgångar</strong>:
        </p>

        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Anläggningstillgångar (långsiktiga)</h3>
        <ul className="list-disc list-inside space-y-2 text-foreground text-[15px] mb-6 ml-4">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Omsättningstillgångar (kortfristiga)</h3>
        <ul className="list-disc list-inside space-y-2 text-foreground text-[15px] mb-6 ml-4">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Skulder och eget kapital — hur är det finansierat?</h2>

        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Eget kapital</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Långfristiga skulder</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
          Skulder med löptid längre än ett år: banklån, checkräkningskredit, obligationer.
        </p>

        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Kortfristiga skulder</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Hur läser du balansrapporten?</h2>

        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Soliditet</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Likviditet</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Jämför över tid</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
