    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-b from-gray-50 to-white py-16 px-6 border-b border-gray-100">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-gray-900 leading-tight mb-5">Så fungerar avtalsfakturering</h1>
      ...
      <article className="max-w-3xl mx-auto px-6 py-16">
        ...
        <h2 className="text-2xl font-black text-gray-900 mt-12 mb-4">Vad är avtalsfakturering?</h2>
        ...
        <h2 className="text-2xl font-black text-gray-900 mt-12 mb-4">Vanliga användningsområden</h2>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-gray-900 mt-12 mb-4">Så sätter du upp avtalsfakturering i Endoo</h2>

        <h3 className="text-lg font-bold text-gray-900 mt-8 mb-3">Steg 1: Skapa ett avtal</h3>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-gray-900 mt-8 mb-3">Steg 2: Lägg till avtalsrader</h3>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-gray-900 mt-8 mb-3">Steg 3: Välj leveranssätt</h3>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-gray-900 mt-8 mb-3">Steg 4: Aktivera avtalet</h3>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-gray-900 mt-12 mb-4">Prisfrysning och indexuppräkning</h2>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-gray-900 mt-12 mb-4">Fördelarna med automatisering</h2>

        <h3 className="text-lg font-bold text-gray-900 mt-8 mb-3">Förutsägbar likviditet</h3>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-gray-900 mt-8 mb-3">Inga glömda fakturor</h3>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-gray-900 mt-8 mb-3">Professionellt intryck</h3>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
