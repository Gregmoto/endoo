    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-b from-gray-50 to-white py-16 px-6 border-b border-gray-100">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-gray-900 leading-tight mb-5">Vad är en SIE-fil?</h1>
      ...
      <article className="max-w-3xl mx-auto px-6 py-16">
        ...
        <h2 className="text-2xl font-black text-gray-900 mt-12 mb-4">Vad är SIE?</h2>
        ...
        <h2 className="text-2xl font-black text-gray-900 mt-12 mb-4">De fem SIE-typerna</h2>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
          ...
          <table className="w-full text-[14px] border-collapse">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                ...
                <th className="text-left p-3 font-semibold text-gray-700">Vanligast för</th>
              </tr>
            </thead>
        ...
        <h2 className="text-2xl font-black text-gray-900 mt-12 mb-4">När behöver du en SIE-fil?</h2>

        <h3 className="text-lg font-bold text-gray-900 mt-8 mb-3">Vid revision</h3>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-gray-900 mt-8 mb-3">Vid systembyte</h3>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-gray-900 mt-8 mb-3">Arkivering</h3>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-gray-900 mt-8 mb-3">Kommunikation med redovisningsbyrå</h3>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-gray-900 mt-12 mb-4">Hur exporterar du en SIE-fil från Endoo?</h2>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
