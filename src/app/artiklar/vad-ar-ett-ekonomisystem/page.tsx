    ...
    <main className="min-h-screen bg-card">
      ...
      <div className="bg-gradient-to-b from-gray-50 to-white py-16 px-6 border-b border">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-foreground leading-tight mb-5">Vad är ett ekonomisystem?</h1>
      ...
      <article className="max-w-3xl mx-auto px-6 py-16">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Definition: vad är ett ekonomisystem?</h2>
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Vad gör ett ekonomisystem?</h2>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Varför behöver ditt företag ett ekonomisystem?</h2>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Spara tid</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Undvika misstag</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Bättre beslutsunderlag</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Ekonomisystem vs. Excel — vad är skillnaden?</h2>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
          ...
          <table className="w-full text-[14px] border-collapse">
            <thead>
              <tr className="bg-muted border-b border">
                <th className="text-left p-3 font-semibold text-foreground">Funktion</th>
                <th className="text-left p-3 font-semibold text-foreground">Excel</th>
                <th className="text-left p-3 font-semibold text-foreground">Ekonomisystem</th>
              </tr>
            </thead>
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Gamla system vs. moderna alternativ</h2>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Vad ska du titta efter när du väljer?</h2>

        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">1. Täcker det dina behov?</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">2. Är det enkelt att använda?</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">3. Kan det växa med dig?</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
          Välj ett system som hanterar fler kunder, fler transaktioner och fler anställda utan att du behöver byta om ett år.
        </p>

        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">4. Stödjer det SIE-export?</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">5. Vad kostar det?</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
