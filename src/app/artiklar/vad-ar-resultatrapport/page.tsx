    ...
    <main className="min-h-screen bg-card">
      ...
      <div className="bg-gradient-to-b from-gray-50 to-white py-16 px-6 border-b border">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-foreground leading-tight mb-5">Vad är en resultatrapport?</h1>
      ...
      <article className="max-w-3xl mx-auto px-6 py-16">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Vad är skillnaden mot balansrapporten?</h2>
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Strukturen i en resultatrapport</h2>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
          En typisk resultatrapport följer denna struktur uppifrån och ner:
        </p>

        <div className="bg-muted border border rounded-xl p-6 mb-8 text-[14px]">
          <div className="space-y-2 text-foreground">
            <div className="flex justify-between font-semibold text-foreground pb-2 border-b border">
            ...
            <div className="flex justify-between font-semibold border-t border pt-2">
            ...
            <div className="flex justify-between font-semibold border-t border pt-2 text-green-700">
            ...
            <div className="flex justify-between font-bold border-t border pt-2 text-foreground">
            ...
            <div className="flex justify-between font-black border-t border pt-2 text-indigo-700">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Viktiga nyckeltal i resultatrapporten</h2>

        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Bruttomarginal</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Rörelsemarginal (EBIT-marginal)</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Nettomarginal</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Hur använder du resultatrapporten i praktiken?</h2>

        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Månadsvis uppföljning</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Budgetuppföljning</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Prisjusteringar</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
