    ...
    <main className="min-h-screen bg-card">
      ...
      <div className="bg-gradient-to-b from-gray-50 to-white py-16 px-6 border-b border">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-foreground leading-tight mb-5">Vad är en huvudbok?</h1>
      ...
      <article className="max-w-3xl mx-auto px-6 py-16">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Definition: vad är en huvudbok?</h2>
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Huvudbok vs. verifikatslista — vad är skillnaden?</h2>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
          ...
          <table className="w-full text-[14px] border-collapse">
            <thead>
              <tr className="bg-muted border-b border">
                <th className="text-left p-3 font-semibold text-foreground">Rapport</th>
                <th className="text-left p-3 font-semibold text-foreground">Sorterat efter</th>
                <th className="text-left p-3 font-semibold text-foreground">Bra för</th>
              </tr>
            </thead>
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Hur läser du en huvudbok?</h2>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
          En typisk rad i huvudboken ser ut så här:
        </p>

        <div className="bg-muted border border rounded-xl p-5 mb-6 font-mono text-[13px] text-foreground overflow-x-auto">
          <div className="grid grid-cols-5 gap-2 font-semibold text-muted-foreground mb-2 text-[12px] uppercase tracking-wider">
            <span>Datum</span>
            <span>Ver.nr</span>
          ...
          <div className="grid grid-cols-5 gap-2 border-t border pt-2">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Sambandet med andra rapporter</h2>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">När används huvudboken i praktiken?</h2>

        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Felsökning av avvikelser</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Stämma av bankkontot</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Revision</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
