    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-b from-gray-50 to-white py-16 px-6 border-b border-gray-100">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-gray-900 leading-tight mb-5">Så fungerar digital fakturering</h1>
      ...
      <article className="max-w-3xl mx-auto px-6 py-16">
        ...
        <h2 className="text-2xl font-black text-gray-900 mt-12 mb-4">Vad är en faktura?</h2>
        ...
        <h2 className="text-2xl font-black text-gray-900 mt-12 mb-4">Vad måste en faktura innehålla?</h2>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-gray-900 mt-12 mb-4">E-postfaktura vs. pappersfaktura</h2>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-gray-900 mt-8 mb-3">E-faktura (Peppol)</h3>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-gray-900 mt-12 mb-4">Betalningstider och villkor</h2>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-gray-900 mt-8 mb-3">Dröjsmålsränta</h3>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-gray-900 mt-12 mb-4">Påminnelser och inkasso</h2>

        <h3 className="text-lg font-bold text-gray-900 mt-8 mb-3">Påminnelseavgift</h3>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-gray-900 mt-8 mb-3">Inkasso</h3>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-gray-900 mt-12 mb-4">Kreditnotor</h2>
        <p className="text-gray-700 leading-relaxed mb-4 text-[15px]">
