    ...
    <main className="min-h-screen bg-card">
      ...
      <div className="bg-gradient-to-b from-gray-50 to-white py-16 px-6 border-b border">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-foreground leading-tight mb-5">Så kan AI hjälpa med bokföring</h1>
      ...
      <article className="max-w-3xl mx-auto px-6 py-16">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Vad kan AI göra inom bokföring idag?</h2>
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">OCR och tolkning av leverantörsfakturor</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Automatiska kontoförslag</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Momsverifiering</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Ekonomisk assistent</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h3 className="text-lg font-bold text-foreground mt-8 mb-3">Avvikelsedetektering</h3>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">Vad kan AI inte göra?</h2>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
        ...
        <h2 className="text-2xl font-black text-foreground mt-12 mb-4">AI i Endoo</h2>
        <p className="text-foreground leading-relaxed mb-4 text-[15px]">
