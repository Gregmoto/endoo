  ...
  return (
    <div className="p-8">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">{total} totalt · {active} aktiva på sidan · {agencies} byråer</p>
      </div>
      ...
      <div className="mb-4 flex gap-3 flex-wrap">
        <input
          ...
          className="flex-1 min-w-48 max-w-xs px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
        />
        ...
        <CardContent className="p-0">
          {loading ? (
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {orgs.map(org => (
                  <tr key={org.id} className={`border-t border-gray-50 hover:bg-gray-50 ${org.deletedAt ? "opacity-50" : ""}`}>
                    ...
                    <td className="px-6 py-3">
                      <span className={`px-2 py-0.5 text-xs rounded-full font-medium ${org.type === "agency" ? "bg-purple-100 text-purple-700" : "bg-gray-100 text-gray-600"}`}>
