...
export default function ReportsPage() {
  ...
  return (
    <div className="p-8 max-w-4xl">
      <h1 className="text-2xl font-bold text-foreground mb-1">Rapporter</h1>
      <p className="text-sm text-muted-foreground mb-8">Välj en rapport nedan.</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {REPORT_CARDS.map((card) => (
          <Link
            key={card.href}
            href={`${base}${card.href}`}
            className="flex flex-col gap-2 p-5 bg-card border border rounded-xl hover:border-brand-400 hover:shadow-sm transition-all"
          >
