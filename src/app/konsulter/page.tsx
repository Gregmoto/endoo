    ...
    <main className="min-h-screen bg-card text-foreground">
      ...
      <section className="pt-20 pb-24 px-6 bg-gradient-to-b from-indigo-50/40 to-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="mt-6 text-sm text-muted-foreground">Inget kreditkort · Kom igång på 2 minuter</p>
        </div>
      </section>
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-foreground mb-4">Allt du behöver som konsult</h2>
            <p className="text-lg text-muted-foreground">Från faktura till deklaration — utan krångel.</p>
          </div>
