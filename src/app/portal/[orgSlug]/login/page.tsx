  ...
  if (sent) {
    return (
      <div style={card}>
        ...
        <p style={{ ...body, color: "var(--muted-foreground)" }}>Inget mail? Kontrollera skräpposten eller försök igen.</p>
...
const label: React.CSSProperties = { display: "block", fontSize: 13, fontWeight: 600, color: "var(--foreground)", marginBottom: 6 }
const input: React.CSSProperties = { width: "100%", boxSizing: "border-box", padding: "10px 14px", border: "1px solid var(--border)", borderRadius: 8, fontSize: 14, outline: "none" }
...
const link: React.CSSProperties  = { background: "none", border: "none", color: "var(--primary)", cursor: "pointer", fontSize: 14, padding: 0, textDecoration: "underline" }
