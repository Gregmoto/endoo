        ...
        {!showDetails ? (
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <div className="flex items-center gap-2 flex-shrink-0 w-full sm:w-auto">
              <button
                ...
                className="flex-1 sm:flex-none px-4 py-2 text-xs font-semibold text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
              >
                Neka
              </button>
              <button
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={() => setShowDetails(false)} className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 text-lg leading-none">✕</button>
            </div>
            ...
            <div className="space-y-3 mb-5">
              ...
              <label className="flex items-start justify-between gap-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-xl cursor-pointer">
                ...
                >
                  <span className={`absolute top-0.5 w-3 h-3 bg-white rounded-full shadow transition-transform ${analytics ? "translate-x-4" : "translate-x-0.5"}`} />
                </button>
              </label>
              ...
              <label className="flex items-start justify-between gap-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-xl cursor-pointer">
                ...
                >
                  <span className={`absolute top-0.5 w-3 h-3 bg-white rounded-full shadow transition-transform ${marketing ? "translate-x-4" : "translate-x-0.5"}`} />
                </button>
              </label>
            </div>
            ...
            <div className="flex items-center gap-2 justify-end">
              <button
                onClick={rejectOptional}
                className="px-4 py-2 text-xs font-semibold text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
              >
                Neka alla
              </button>
              <button
