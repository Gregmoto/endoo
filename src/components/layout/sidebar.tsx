    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-3 py-2 border-b border-gray-50">
        <button
          ...
          className="w-full flex items-center gap-2 px-3 py-2 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors text-sm text-gray-400 border border-gray-100"
        >
          ...
          <div>
            ...
            <div className="space-y-0.5">
              ...
              <Link
                ...
                className={cn(
                  "flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors min-h-[44px]",
                  isActive("/alerts") ? "bg-brand-50 text-brand-700" : "text-gray-600 hover:bg-gray-50 hover:text-gray-900"
                )}
              >
                <span className="text-base leading-none">▲</span>
                Varningar
